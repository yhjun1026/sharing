...
public class SharingRoleOperationExample {
    ...
    public SharingRoleOperationExample() {
    ...
    public SharingRoleOperationExample sumId() {
        this.sumCol="id";
        return this;
    }

    public SharingRoleOperationExample sumRoleType() {
        this.sumCol="role_type";
        return this;
    }

    public SharingRoleOperationExample sumOperationId() {
        this.sumCol="operation_id";
        return this;
    }
    ...
    public SharingRoleOperationExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
