...
public class WxUnifieldRequest {
    	...
    	public WxUnifieldRequest(WxAccount wxaccount, PayIn payin) {
...
//	        reqHandler.setParameter("product_id", this.product_id);
		...
		//	nativeObj.put("total_fee",  String.valueOf((int)(payin.getOri_total_fee()*100)));
			...
			nativeObj.put("notify_url", "www.baidu.com"); 
...
//	        System.out.println("单独的POST" + result);
	        ...
	        if(httpClient.call()) {
	        	...
	        	System.out.println(resHandler.getParameter("prepay_id"));
	        	System.out.println(resHandler.getParameter("code_url"));
	        }else {
