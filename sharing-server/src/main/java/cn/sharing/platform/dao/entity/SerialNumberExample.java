...
public class SerialNumberExample {
    ...
    public SerialNumberExample sumId() {
        this.sumCol="id";
        return this;
    }

    public SerialNumberExample sumDay() {
        this.sumCol="day";
        return this;
    }

    public SerialNumberExample sumBusinessCode() {
        this.sumCol="business_code";
        return this;
    }

    public SerialNumberExample sumNum() {
        this.sumCol="num";
        return this;
    }

    public SerialNumberExample sumCreateTime() {
        this.sumCol="create_time";
        return this;
    }

    public SerialNumberExample sumUpdateTime() {
    ...
    public SerialNumberExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
