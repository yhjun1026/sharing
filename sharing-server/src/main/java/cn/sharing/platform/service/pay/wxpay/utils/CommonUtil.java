...
import cn.sharing.platform.service.pay.wxpay.SDKRuntimeException;
...
public class CommonUtil {
	...
	public static String ArrayToXml(HashMap<String, String> arr) throws UnsupportedEncodingException {
		String xml = "<xml>";
		...
		while (iter.hasNext()) {
			...
			if (key.equals("RetErrMsg")){val = URLEncoder.encode(entry.getValue(), "UTF-8");}else{ val = entry.getValue();}
	...
	public static String ArrayToXmlEx(HashMap<String, String> arr) throws UnsupportedEncodingException {
		String xml = "<xml>";
